...
function init_events() {
    ...
    $(document).on('pageshow','#chatPageTemplate',function(){resizeSendBar('#chatPageTemplate');});
    $(document).on('pageshow','#groupChatPageTemplate',function(){resizeSendBar('#groupChatPageTemplate');});
